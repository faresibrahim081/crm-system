...
const SearchFilter = ({ setSearchId, setSortOrder }) => {
  ...
  return (
    <div className="bg-[#292929] text-white p-4 rounded-lg shadow-md w-full">
      <h1 className="font-bold text-[24px] mb-5">العملاء</h1>
      <div className="flex flex-col gap-4 md:flex-row md:items-center">
        ...
        <div className="relative w-full md:w-2/3 lg:w-3/4">
          <input
            ...
            className="w-full h-12 pl-10 pr-4 text-white bg-black rounded-lg shadow-md"
