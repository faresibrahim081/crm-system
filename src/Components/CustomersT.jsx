...
const initialData = [
    ...
    { id: '#098', createdAt: '2024-10-30T12:00:00Z', name: 'Ahmed', website: 'sample2.com', email: 'jane2@sample.com' },
    { id: '#768', createdAt: '2024-10-30T13:00:00Z', name: 'Mohamed ', website: 'sample3.com', email: 'jane3@sample.com' },
    { id: '#453', createdAt: '2024-10-30T14:00:00Z', name: 'Tasneem', website: 'sample4.com', email: 'jane4@sample.com' },
    { id: '#158', createdAt: '2024-10-30T15:00:00Z', name: 'Jane', website: 'sample5.com', email: 'jane5@sample.com' },
    { id: '#009', createdAt: '2024-10-30T16:00:00Z', name: 'Youssef', website: 'sample6.com', email: 'jane6@sample.com' },
    { id: '#563', createdAt: '2024-10-30T17:00:00Z', name: 'Hazem', website: 'sample7.com', email: 'jane7@sample.com' },
];
        ...
        <div className=' container' style={{ padding: '20px', maxWidth: '1200px', margin: 'auto' }}>
            ...
            <div className="flex  mt-10 ">
                <div className="relative w-3/4 mb-5">
                    <FaSearch className="absolute left-3 top-6 transform -translate-y-1/2 text-gray-500" />
                    <input
                        type="text"
                        placeholder="البحث عن طريق ID "
                        className="p-2 pl-10 w-full rounded-lg shadow-md text-white bg-black "
                        value={searchTerm}
                        onChange={(e) => setSearchTerm(e.target.value)}
                    />
                </div>
                <div className=" w-1/4 mb-5 pr-9 text-center   ">
                 <Select
                    options={options}
                    styles={customStyles}
                            ...
                            sortedData.map((customer) => (
                                <tr key={customer.id} >
                                    ...
                                    <td data-label="Status">
                                        <button className="px-2 py-1 bg-green-200 text-gray-800 border-none rounded-md cursor-pointer hover:bg-emerald-400 hover:text-gray-900 transition duration-200">
                                            show status
                                        </button>
                                    </td>
                                    ...
                                    <FaEdit
                                     ...
                                     className="cursor-pointer text-gray-500 hover:text-red-500 mr-3"
                                     />
                                     </div>
                                    </td>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <input
                            ...
                            placeholder="Name"
                            className="p-2 mb-3 border border-gray-300 rounded-lg w-full"
                        />
                        <input
                            type="text"
